...
$faciltyTypeArray=array("Dive Shop","Firehall","Commercial Dive Operation","Independent Supplier","Dive Club","Other (Notes)");
...
global $DiveSupportPhone1,$DiveSupportPhone2,$DiveSupportExactLat,$DiveSupportExactLong;
global $DiveSupportHoursMon,$DiveSupportHoursTues,$DiveSupportHoursWed,$DiveSupportHoursThu;
global $DiveSupportHoursFri,$DiveSupportHoursSat,$DiveSupportHoursSun,$DiveSupportServices;
global $DiveSupportSuppliersNote,$DiveSupportNotes,$DiveSupportPaidDate,$DiveSupportWebsite;
...
$DiveSupportPhone2=$rowdata[10];
$DiveSupportExactLat=$rowdata[11];
$DiveSupportExactLong=$rowdata[12];
$DiveSupportHoursMon=$rowdata[13];
$DiveSupportHoursTues=$rowdata[14];
$DiveSupportHoursWed=$rowdata[15];
$DiveSupportHoursThu=$rowdata[16];
$DiveSupportHoursFri=$rowdata[17];
$DiveSupportHoursSat=$rowdata[18];
$DiveSupportHoursSun=$rowdata[19];
$DiveSupportServices=$rowdata[20];
$DiveSupportSuppliersNote=$rowdata[21];
$DiveSupportNotes=$rowdata[22];
$DiveSupportPaidDate=$rowdata[23];
}
...
$DiveSupportNotes=$rowdata[22];
$DiveSupportPaidDate=$rowdata[23];
$DiveSupportPaidDate=$rowdata[24];
}
PutVariablesIntoSession();
return;
}
...
global $DiveSupportSuppliersNote,$DiveSupportNotes,$DiveSupportPaidDate,$DiveSupportWebsite;
global $Mode;
global $faciltyTypeArray,$facilityServicesArray;
...
$tabcount=2;
	$numPossibleElements = count($faciltyTypeArray);
...
if(strlen($DiveSupportType)!=0)
 {
 	  	for($i=0;$i < $numPossibleElements;$i++)
 	  {
 	  	...
 	  	echo stripslashes("<td><input type= 'checkbox' name='SupportType[]' value='".$faciltyTypeArray[$i]."'tabindex=".$tabcount." ".$state.">".$faciltyTypeArray[$i]."</td>");  
 	  }	
 ...
 { 
 	  	...
 	  	for($i=0;$i < $numPossibleElements;$i++)
 	     {
 	     	 ...
 	     	 $tabcount++;
 	       if($faciltyTypeArray[$i] == 'Dive Shop') {$state='checked';} else {$state='';}
...
echo("<tr><th>Phone:</th><td colspan ='5'><table>");
...
echo stripslashes("<th valign='top' align ='left' scope='row'>Phone 2</th>");
echo ("<td><input type ='text' NAME='DiveSupportPhone2' VALUE='$DiveSupportPhone2'  SIZE='15' MAXLENGTH='15'  tabindex='11' id ='DiveSupportPhone2' 
...
echo("<tr><th valign='top' align ='left' scope='row'>Website</th>");
echo ("<td><input type ='text' NAME='DiveSupportWebsite' VALUE='$DiveSupportWebsite'  SIZE='100' MAXLENGTH='100'  tabindex='11' id ='DiveSupportWebsite' 
...
echo("<tr><th valign='top' align ='left' scope='row'>DiveSupportExactLat</th>");
echo ("<td><input type ='text' NAME='DiveSupportExactLat' VALUE='$DiveSupportExactLat'  SIZE='11,7' MAXLENGTH='11,7'  tabindex='12' id ='DiveSupportExactLat' 
...
echo stripslashes("<th valign='top' align ='left' scope='row'>DiveSupportExactLong</th>");
...
echo("<tr><th>Hours of Operation<br>24 hour clock: ####-####</td><td colspan='5'></th><table>");
...
if(strlen($DiveSupportServices)!=0)
 {
 	  	for($i=0;$i < $numPossibleElements;$i++)
 	  {
 	  	...
 	  	echo stripslashes("<td><input type= 'checkbox' name='SupportType[]' value='".$facilityServicesArray[$i]."'tabindex=".$tabcount." ".$state.">".$facilityServicesArray[$i]."</td>");  
 	    ...
 	    if($facilityServicesArray[$i] == 'Dive Instruction'){echo('</tr><tr>');}
 	    if($facilityServicesArray[$i] == 'BSAC'){echo('</tr><tr>');}
 	  }	
...
echo("<tr><th valign='top' align ='left' scope='row'>DiveSupportSuppliersNote</th>
<td><TEXTAREA NAME='DiveSupportSuppliersNote' COLS=100 ROW=3 TABINDEX='22'>$DiveSupportSuppliersNote</TEXTAREA></td>");
echo stripslashes("</tr>
<tr><th valign='top' align ='left' scope='row'>DiveSupportNotes</th>
<td><TEXTAREA NAME='DiveSupportNotes' COLS=100 ROW=3 TABINDEX='23'>$DiveSupportNotes</TEXTAREA></td>");
echo stripslashes("</tr>
<tr><th valign='top' align ='left' scope='row'>DiveSupportPaidDate</th>
<td><input type ='text' NAME='DiveSupportPaidDate' VALUE='$DiveSupportPaidDate'  SIZE='11' MAXLENGTH='11'  tabindex='24' id ='DiveSupportPaidDate' 
...
");
echo ("<td><input type ='text'READONLY NAME='DiveSupportPhone2' VALUE='$DiveSupportPhone2'  SIZE='15' MAXLENGTH='15'  tabindex='11' id ='DiveSupportPhone2' 
   onBlur=\"if(isBlank(this.form.DiveSupportPhone2.value)) {alert('DiveSupportPhone2 cannot be blank');this.form.DiveSupportPhone2.style.background='Yellow';}else{this.form.DiveSupportPhone2.style.background='White';}\"><br /></td>");
echo stripslashes("</tr>
<tr><th align ='left' valign='top' scope='row'>DiveSupportExactLat</th>
");
echo ("<td><input type ='text'READONLY NAME='DiveSupportExactLat' VALUE='$DiveSupportExactLat'  SIZE='11,7' MAXLENGTH='11,7'  tabindex='12' id ='DiveSupportExactLat' 
   onBlur=\"if(isBlank(this.form.DiveSupportExactLat.value)) {alert('DiveSupportExactLat cannot be blank');this.form.DiveSupportExactLat.style.background='Yellow';}else{this.form.DiveSupportExactLat.style.background='White';}\"><br /></td>");
echo stripslashes("</tr>
...
");
echo ("<td><input type ='text'READONLY NAME='DiveSupportServices' VALUE='$DiveSupportServices'  SIZE='25' MAXLENGTH='25'  tabindex='21' id ='DiveSupportServices' 
   onBlur=\"if(isBlank(this.form.DiveSupportServices.value)) {alert('DiveSupportServices cannot be blank');this.form.DiveSupportServices.style.background='Yellow';}else{this.form.DiveSupportServices.style.background='White';}\"><br /></td>");
echo stripslashes("</tr>
<tr><th align ='left' valign='top' scope='row'>DiveSupportSuppliersNote</th>
<td><TEXTAREA NAME='DiveSupportSuppliersNote' READONLY COLS=100 ROW=3 TABINDEX='22'>$DiveSupportSuppliersNote</TEXTAREA></td>");
echo stripslashes("</tr>
<tr><th align ='left' valign='top' scope='row'>DiveSupportNotes</th>
<td><TEXTAREA NAME='DiveSupportNotes' READONLY COLS=100 ROW=3 TABINDEX='23'>$DiveSupportNotes</TEXTAREA></td>");
echo stripslashes("</tr>
<tr><th align ='left' valign='top' scope='row'>DiveSupportPaidDate</th>
<td><input type ='text'READONLY NAME='DiveSupportPaidDate' VALUE='$DiveSupportPaidDate'  SIZE='11' MAXLENGTH='11'  tabindex='24' id ='DiveSupportPaidDate'>");
if($Mode=='EDIT')
{echo '<A HREF="#" onClick="cal.select(document.forms[\'DiveSupportEdit\'].DiveSupportPaidDate,\'anchor\',\'yyyy-MM-dd\');return false;" NAME="anchor" ID="anchor">Calendar</A>';}
else 
{echo '<A HREF="#" onClick="cal.select(document.forms[\'DiveSupportEntry\'].DiveSupportPaidDate,\'anchor\',\'yyyy-MM-dd\');return false;" NAME="anchor" ID="anchor">Calendar</A>';}
...
<tr><th align ='left' valign='top' scope='row'>DiveSupportPhone2</th>
");
echo ("<td><input type ='text'READONLY NAME='DiveSupportPhone2' VALUE='$DiveSupportPhone2'  SIZE='15' MAXLENGTH='15'  tabindex='11' id ='DiveSupportPhone2'><br /></td>");
echo stripslashes("</tr>
<tr><th align ='left' valign='top' scope='row'>DiveSupportExactLat</th>
");
echo ("<td><input type ='text'READONLY NAME='DiveSupportExactLat' VALUE='$DiveSupportExactLat'  SIZE='11,7' MAXLENGTH='11,7'  tabindex='12' id ='DiveSupportExactLat'><br /></td>");
echo stripslashes("</tr>
<tr><th align ='left' valign='top' scope='row'>DiveSupportExactLong</th>
");
echo ("<td><input type ='text'READONLY NAME='DiveSupportExactLong' VALUE='$DiveSupportExactLong'  SIZE='11,7' MAXLENGTH='11,7'  tabindex='13' id ='DiveSupportExactLong'><br /></td>");
echo stripslashes("</tr>
<tr><th align ='left' valign='top' scope='row'>DiveSupportHoursMon</th>
");
echo ("<td><input type ='text'READONLY NAME='DiveSupportHoursMon' VALUE='$DiveSupportHoursMon'  SIZE='10' MAXLENGTH='10'  tabindex='14' id ='DiveSupportHoursMon'><br /></td>");
echo stripslashes("</tr>
<tr><th align ='left' valign='top' scope='row'>DiveSupportHoursTues</th>
");
echo ("<td><input type ='text'READONLY NAME='DiveSupportHoursTues' VALUE='$DiveSupportHoursTues'  SIZE='10' MAXLENGTH='10'  tabindex='15' id ='DiveSupportHoursTues'><br /></td>");
echo stripslashes("</tr>
<tr><th align ='left' valign='top' scope='row'>DiveSupportHoursWed</th>
");
echo ("<td><input type ='text'READONLY NAME='DiveSupportHoursWed' VALUE='$DiveSupportHoursWed'  SIZE='10' MAXLENGTH='10'  tabindex='16' id ='DiveSupportHoursWed'><br /></td>");
echo stripslashes("</tr>
<tr><th align ='left' valign='top' scope='row'>DiveSupportHoursThu</th>
");
echo ("<td><input type ='text'READONLY NAME='DiveSupportHoursThu' VALUE='$DiveSupportHoursThu'  SIZE='10' MAXLENGTH='10'  tabindex='17' id ='DiveSupportHoursThu'><br /></td>");
echo stripslashes("</tr>
<tr><th align ='left' valign='top' scope='row'>DiveSupportHoursFri</th>
");
echo ("<td><input type ='text'READONLY NAME='DiveSupportHoursFri' VALUE='$DiveSupportHoursFri'  SIZE='10' MAXLENGTH='10'  tabindex='18' id ='DiveSupportHoursFri'><br /></td>");
echo stripslashes("</tr>
<tr><th align ='left' valign='top' scope='row'>DiveSupportHoursSat</th>
");
echo ("<td><input type ='text'READONLY NAME='DiveSupportHoursSat' VALUE='$DiveSupportHoursSat'  SIZE='10' MAXLENGTH='10'  tabindex='19' id ='DiveSupportHoursSat'><br /></td>");
echo stripslashes("</tr>
<tr><th align ='left' valign='top' scope='row'>DiveSupportHoursSun</th>
");
echo ("<td><input type ='text'READONLY NAME='DiveSupportHoursSun' VALUE='$DiveSupportHoursSun'  SIZE='10' MAXLENGTH='10'  tabindex='20' id ='DiveSupportHoursSun'><br /></td>");
echo stripslashes("</tr>
<tr><th align ='left' valign='top' scope='row'>DiveSupportServices</th>
");
echo ("<td><input type ='text'READONLY NAME='DiveSupportServices' VALUE='$DiveSupportServices'  SIZE='25' MAXLENGTH='25'  tabindex='21' id ='DiveSupportServices'><br /></td>");
echo stripslashes("</tr>
<tr><th align ='left' valign='top' scope='row'>DiveSupportSuppliersNote</th>
<td><TEXTAREA NAME='DiveSupportSuppliersNote' READONLY COLS=100 ROW=3 TABINDEX='22'>$DiveSupportSuppliersNote</TEXTAREA></td>");
echo stripslashes("</tr>
...
$sql=$sql."DiveSupportWebsite='".strip_tags(addslashes($DiveSupportWebsite))."' where DiveSupportId='".$DiveSupportId."'"; 
