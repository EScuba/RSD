...
"settings":
{
	"data_settings" : 
	{
		...
		"save_file" : 
		{
			"filename" : "registration-results.csv",
			"is_present" : true
		},
		"save_sqlite" : 
		{
			"database" : "HAWGSRegistration.dat",
			"is_present" : false,
			"tablename" : "HAWGSRegistration"
		}
	},
	"email_settings" : 
	{
	...
	"uid" : "8df2522c07741769ab0b33c228b2a8d5",
	"validation_report" : "in_line"
},
"rules":{"username":{"label":"Username","fieldtype":"text","required":true},"userpassword":{"minlength":5,"label":"Password","fieldtype":"password","required":true,"equalTo":"password20_verification","label_equal":"Confirm","maxlength":"20"},"name":{"label":"Name ","fieldtype":"text","maxlength":"100","required":true,"messages":"A name or user handle is required."},"email":{"email":true,"label":"Email","fieldtype":"email","required":true,"equalTo":"email_verification","label_equal":"Confirm","messages":"Email address is required"},"emailradio":{"label":"May we use your email for notifications","required":true,"fieldtype":"radiogroup","messages":"Yes or No response is required.","values":["No","Yes"]},"phone":{"phone":"phoneUS","label":"Phone Number","fieldtype":"tel","required":true},"phoneradio":{"label":"May we use your phone for text notifications?","required":true,"fieldtype":"radiogroup","values":["No","Yes"]},"certlevel":{"label":"Certification Level","fieldtype":"listbox","required":false,"values":["Open Water","Advanced Open Water","Rescue","Divemaster","Instructor"]},"specialties":{"label":"Specialties","fieldtype":"listbox","values":["Drysuit","Navigation","Search and Recovery","Deep","Night","PPB"]},"usercomments":{"label":"Comments","fieldtype":"textarea","maxlength":"10000"}},
"payment_rules":{"emailradio":{},"phoneradio":{},"certlevel":{},"specialties":{}},
"conditional_rules":{},
